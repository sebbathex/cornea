...
def write_page_1():
    ...
    with st.expander("Show/Hide Accordion Content"):
        st.write("This is the content of the accordion section.")
        st.write("It will be hidden by default and can be shown by clicking on the header.")
